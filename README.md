...
**3. Explain the difference between a script and a transaction.**
	...
	The script is used to browse the data in the boxchain, it does not change it. And unlike a transaction, it doesn't charge any fees because it costs nothing.

<h1>Chapter 1, day 2</h1>
