...
1. We don't call _ChangeGreeting_ in the script because this function is called in the _HelloWorld_ contract, and we return this contract in the script by calling the _main_ function.
2. _AuthAccount_ at the _prepare_ stage gives access to the data to the account of the user signing the transaction.
